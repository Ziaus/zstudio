        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-col md:flex-row p-6 text-gray-900 dark:text-gray-100">
                    <a href="<?php echo e(route('front.upload')); ?>" class=" card block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
...
<?php endif; ?>
<?php /**PATH /home/devziaus/htdocs/zstudio/resources/views/welcome.blade.php ENDPATH**/ ?>