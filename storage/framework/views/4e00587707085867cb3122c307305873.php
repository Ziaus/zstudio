...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
  <head>
    ...
    <title><?php echo e(config('app.name', 'ZStudio')); ?> Admin Dashboard</title>
    <link
      href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
      rel="stylesheet"
    />
    <link rel="stylesheet" href="<?php echo e(asset('custom/backend')); ?>/assets/css/tailwind.output.css" />
    <script
      src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js"
      defer
    ></script>
    <script src="<?php echo e(asset('custom/backend')); ?>/assets/js/init-alpine.js"></script>
    <link
      rel="stylesheet"
    ...
    <script
      ...
      defer
    ></script>
    <script src="<?php echo e(asset('custom/backend')); ?>/assets/js/charts-lines.js" defer></script>
    <script src="<?php echo e(asset('custom/backend')); ?>/assets/js/charts-pie.js" defer></script>
    ...
    >
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          >
            <img class="flex justify-center mx-auto" style="width: 50%;" src="<?php echo e(asset('logo.png')); ?>" alt="Logo">
          </a>
          <ul class="mt-6">
          ...
          <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="<?php echo e(route('all.users')); ?>">All Users</a>
                  </li>
                  <?php if((Auth::user()->role == '1')): ?>
                    ...
                    <li
                      class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    >
                      <a class="w-full" href="<?php echo e(route('all.roles')); ?>">User Role</a>
                    </li>
                  <?php endif; ?>
                </ul>
              </template>
            ...
            <li class="relative px-6 py-3">
              <a
                ...
                href="<?php echo e(route('all.clients')); ?>"
              >
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo e(route('all.orders')); ?>"
              >
              <svg class="w-5 h-5" fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                <g>
                  <g>
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          <a
            ...
            href="<?php echo e(route('admin.dashboard')); ?>"
          >
          <img class="flex justify-center mx-auto" style="width: 25%;" src="<?php echo e(asset('logo.png')); ?>" alt="Logo">
          </a>
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              <span
...
<?php /**PATH /home/devziaus/htdocs/zstudio/resources/views/layouts/admin.blade.php ENDPATH**/ ?>