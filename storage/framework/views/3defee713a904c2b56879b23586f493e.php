  ...
  <div class="w-full mt-4 max-w-screen-xl px-4 mx-auto lg:px-12">
    ...
    <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
      <div class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
        <div>
          <h5 class="mr-3 font-semibold dark:text-white">Orders No <?php echo e($order->id); ?></h5>
          <p class="text-gray-500 dark:text-gray-400">View and upload completed file for order of <?php echo e($order->userInfo->name); ?></p>
        </div>
      </div>
    </div>
  </div>
        ...
        <table class="w-full whitespace-no-wrap">
            <tbody class=" text-center bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td>:</td>
                    <td class="px-4 py-3 text-sm"><?php echo e($order->userInfo->name); ?></td>
                </tr>
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                  ...
                  <td class="px-4 py-3 text-sm">
                    <form action="<?php echo e(route('update.bill')); ?>" method="post">
                      <?php echo csrf_field(); ?>
                      <input type="hidden" name="id" value="<?php echo e($order->id); ?>">
                      <input type="text" class="w-18 p-1 rounded bg-white dark:bg-gray-700 text-center mr-2 mb-2 dark:text-white dark:focus:ring-green-800" id="" name="bill" value="<?php echo e($order->bill); ?>">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                  ...
                  <td>:</td>
                  <td class="px-4 py-3 text-sm">
                    <form action="<?php echo e(route('update.eta')); ?>" method="post">
                      <?php echo csrf_field(); ?>
                      <input type="hidden" name="id" value="<?php echo e($order->id); ?>">
                      <input type="text" class="w-1/2 p-1 rounded bg-white dark:bg-gray-700 text-center mr-2 mb-2 dark:text-white dark:focus:ring-green-800" id="" name="eta" value="<?php echo e($order->eta); ?>">
                      <button type="submit" class="rounded-full text-green-800 bg-white">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4.89163 13.2687L9.16582 17.5427L18.7085 8" stroke="#023020" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td>:</td>
                    <td class="px-4 py-3 text-sm"> 
                      <?php echo e($order->osInfo->os_name); ?>

                      <form class="inline-block" action="<?php echo e(route('update.os')); ?>" method="post">
                      <?php echo csrf_field(); ?>
                      <input type="hidden" name="id" value="<?php echo e($order->id); ?>">
                      <button type="submit" class="rounded-full text-green-800 bg-white">
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <form class="inline-block" action="<?php echo e(route('update.ps')); ?>" method="post">
                      <?php echo csrf_field(); ?>
                      <input type="hidden" name="id" value="<?php echo e($order->id); ?>">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3 text-sm">
                      <form class="w-full" method="post" action="<?php echo e(route('update.order')); ?>">
                        ...
                        <a href="<?php echo e(route('all.orders')); ?>" type="button" class="text-gray-800 bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-xs px-3 py-2 text-center mr-2 mb-2 dark:text-white dark:focus:ring-green-800">Cancel</a>
                      </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devziaus/htdocs/zstudio/resources/views/backend/orders/view.blade.php ENDPATH**/ ?>