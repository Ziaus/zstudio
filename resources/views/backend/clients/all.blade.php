        ...
        <table class="w-full whitespace-no-wrap">
            ...
            <tbody class=" text-center bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-xs"> {{$client->email}} </td>
                <td class="px-4 py-3 text-sm"> {{$client->phone}} </td>
                <td class="px-4 py-3 text-sm"> --- </td>
                <td class="px-4 py-3 text-sm">
                  <a href="{{route('view.client',[$client->id])}}" type="button" class="text-gray-800 bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:text-white dark:focus:ring-green-800">View</a>
                  @if((Auth::user()->role == '1'))
